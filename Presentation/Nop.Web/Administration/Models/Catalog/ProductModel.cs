...
namespace Nop.Admin.Models.Catalog
{
    ...
    public partial class ProductModel : BaseNopEntityModel, ILocalizedModel<ProductLocalizedModel>
    {
        public ProductModel()
        {
            ...
            colorImage = new CustomizedImageModel();
            colorImagelist = new List<CustomizedImageModel>();
        }
        ...
        //public virtual AlienearImageColorMapping colorImage { get; set; }
        public CustomizedImageModel colorImage { get; set; }
        public IList<CustomizedImageModel> colorImagelist { get; set; }
