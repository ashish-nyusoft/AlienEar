...
namespace Nop.Services.Messages
{
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        public void AddOrderCustomerNotesTokens(List<Token> tokens, OrderCustomerNote od)
        {
            tokens.Add(new Token("Order.OrderCustomerNotes", od.CustomerNote));
            tokens.Add(new Token("Today.Date", DateTime.Now.ToString()));
            if (od.CustomerNote != "" && od.CustomerNote != null)
            {
                tokens.Add(new Token("Customer.Notes", "Customer Notes"));
                tokens.Add(new Token("Notes", "Notes -"));
            }
            else
            {
                tokens.Add(new Token("Customer.Notes", ""));
                tokens.Add(new Token("Notes", ""));
            }

            //event notification
            _eventPublisher.EntityTokensAdded(od, tokens);
        }

        public void AddOrderCustomerNotesTokens(List<Token> tokens, string customerNotes)
        {
