...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductAttributeService : IProductAttributeService
    {
        ...
        //Ashish Start
        public virtual ProductAttribute GetProductAttributeNameById(int productAttributeValueId)
        {
            if (productAttributeValueId == 0)
                return null;

            ProductAttribute obj = (from x in _productAttributeRepository.Table
                                   where x.Id == productAttributeValueId
