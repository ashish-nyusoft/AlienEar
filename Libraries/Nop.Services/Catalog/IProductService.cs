...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        //khushi
        List<AlienearImageColorMapping> getPeoductImageAvalable(int productId);
        List<AlienearImageColorMapping> GetProductImagesByProductId(int productId);
        string DeleteProductColorDetails(int colorId);
        string GetColorByColorId(int colorId);
        string GetColorNameByColorId(int colorId);
        List<AlienearImageColorMapping> GetProductImagesAllByProductId(int productId);
        List<AlienearColorMaster> GetColors();
        void InsertProductColorDetails(AlienearColorMaster ProductColor);
        void EditProductColorDetails(AlienearColorMaster ProductColor);
        int GetColorCountByColorName(string ColorName);
        int GetColorCodeCountByColorName(string ColorCode);
        int CheckProductCount(int ColorID, int ProductID);
        void UpdateStatus(int ColorID, int ProductID, bool flag);
        string[] DeleteProductColorImageDetails(int imageId);
        List<AlienearImageColorMapping> GetProductImagesAllByColorIdId(int colorId);
        void InsertProductColorImageDetails(AlienearImageColorMapping ProductColor);
        AlienearImageColorMapping GetProductImagesByProductIdSingle(int productId);
        void DeleteImagesmapping(AlienearImageColorMapping obj);
        //end
