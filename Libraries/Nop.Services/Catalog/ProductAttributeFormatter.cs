                    ...
                    for (int j = 0; j < valuesStr.Count; j++)
                    {
                        ...
                        if (!attribute.ShouldHaveValues())
                        {
                            ...
                            else
                            {
                                ...
                                if (formattedAttribute.Contains(", Hex Code"))
                                {
                                    string[] CoustomDetails = formattedAttribute.Split(',');
                                    formattedAttribute = CoustomDetails[0] + "<span class='hex-code'>," + CoustomDetails[1] + "</span>";
                                }
                            }
                        }
                        else
