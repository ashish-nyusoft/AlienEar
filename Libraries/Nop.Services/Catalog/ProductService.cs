...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        //khushi
        private readonly IRepository<AlienearColorMaster> _alienearproductRepository;
        private readonly IRepository<AlienearImageColorMapping> _alienearproductRepositorymapping;
        //end
        ...
        public ProductService(ICacheManager cacheManager,
            ...
            IStoreMappingService storeMappingService,
             IRepository<AlienearColorMaster> alienearproductRepository,
            IRepository<AlienearImageColorMapping> alienearproductRepositorymapping)
        {
            ...
            this._alienearproductRepository = alienearproductRepository;
            this._alienearproductRepositorymapping = alienearproductRepositorymapping;
        }
        ...
        public virtual List<AlienearImageColorMapping> getPeoductImageAvalable(int productId)
        {
            try
            {
                var data = (from x in _alienearproductRepositorymapping.Table
                            join y in _alienearproductRepository.Table
                            on new { c1 = x.ColorID } equals new { c1 = y.ColorId } into x_y
                            ...
                            select new
                            {
                                ...
                                ImageIdividualFlag = x.ImageIdividualFlag,
                                ImageLeftEar = x.ImageLeftEar,
                                ImageRightEar = x.ImageRightEar,
                                AlienearColorMaster = x_y.FirstOrDefault()
                            }).ToList();

                var data1 = data.Select(x => x.ColorID);

                var unmatch = _alienearproductRepository.Table.Where(x => !data1.Contains(x.ColorId));
                //data.Add(


                List<AlienearImageColorMapping> lst = new List<AlienearImageColorMapping>();
                foreach (var item in data)
                {
                    AlienearImageColorMapping obj = new AlienearImageColorMapping();
                    obj.ImageId = item.ImageId;
                    obj.ImageIdividualFlag = item.ImageIdividualFlag;
                    obj.ImageLeftEar = item.ImageLeftEar;
                    obj.ImageRightEar = item.ImageRightEar;
                    obj.ProductID = item.ProductID;
                    obj.ColorID = item.ColorID;
                    obj.AlienearColorMaster = new AlienearColorMaster();
                    obj.AlienearColorMaster.ColorId = item.AlienearColorMaster.ColorId;
                    obj.AlienearColorMaster.ColorImage = item.AlienearColorMaster.ColorImage;
                    obj.AlienearColorMaster.ColorName = item.AlienearColorMaster.ColorName;
                    lst.Add(obj);
                }
                ...
                foreach (var item in unmatch)
                {
                    ...
                    obj.ImageLeftEar = null;
                    obj.ImageRightEar = null;
                    obj.ProductID = 0;
                    obj.ColorID = item.ColorId;
                    obj.AlienearColorMaster.ColorId = item.ColorId;
                    obj.AlienearColorMaster.ColorImage = item.ColorImage;
                    obj.AlienearColorMaster.ColorName = item.ColorName;
                    lst.Add(obj);

                }
                var a = lst.OrderBy(x => x.AlienearColorMaster.ColorId);
                return a.ToList();
        ...
        public virtual void UpdateStatus(int ColorID, int ProductID, bool flag)
        {
            //var imagePictures = "";
            //var query = from pp in _alienearproductRepositorymapping.Table
            //            //join xx in _alienearproductRepository.Table on pp.ColorID equals xx.ColorId
            //            where pp.ProductID == productId
            //            select pp;
            AlienearImageColorMapping query = _alienearproductRepositorymapping.Table.Where(x => x.ColorID == ColorID && x.ProductID == ProductID).FirstOrDefault();
            //select new
            //{
            //    ImageId = pp.ImageId,
            //    ProductID = pp.ProductID,
            //    ColorID = pp.ColorID,
            //    ImageIdividualFlag = pp.ImageIdividualFlag,
            //    ImageLeftEar = pp.ImageLeftEar,
            //    ImageRightEar = pp.ImageRightEar,
            //    AlienearColorMaster = xx
            //};
            query.ImageIdividualFlag = flag;
            _alienearproductRepositorymapping.Update(query);
            _eventPublisher.EntityUpdated(query);
        }

        public virtual int CheckProductCount(int ColorID, int ProductID)
        {
            //var imagePictures = "";
            //var query = from pp in _alienearproductRepositorymapping.Table
            //            //join xx in _alienearproductRepository.Table on pp.ColorID equals xx.ColorId
            //            where pp.ProductID == productId
            //            select pp;
            var query = _alienearproductRepositorymapping.Table.Where(x => x.ColorID == ColorID && x.ProductID == ProductID).ToList();
            //select new
            //{
            //    ImageId = pp.ImageId,
            //    ProductID = pp.ProductID,
        ...
        public virtual List<AlienearImageColorMapping> GetProductImagesByProductId(int productId)
        {
            //var imagePictures = "";
            //var query = from pp in _alienearproductRepositorymapping.Table
            //            //join xx in _alienearproductRepository.Table on pp.ColorID equals xx.ColorId
            //            where pp.ProductID == productId
            //            select pp;
            var query = _alienearproductRepositorymapping.Table.Where(x => x.ProductID == productId);
            //select new
            //{
            //    ImageId = pp.ImageId,
            //    ProductID = pp.ProductID,
        ...
        public virtual List<AlienearImageColorMapping> GetProductImagesAllByProductId(int productId)
        {
            //var imagePictures = "";
            //var query = from pp in _alienearproductRepositorymapping.Table
            //            //join xx in _alienearproductRepository.Table on pp.ColorID equals xx.ColorId
            //            where pp.ProductID == productId
            //            select pp;
            var query = _alienearproductRepositorymapping.Table.Where(x => x.ProductID == productId && x.ImageIdividualFlag == true);
            //select new
            //{
            //    ImageId = pp.ImageId,
            //    ProductID = pp.ProductID,
        ...
        public virtual void DeleteImagesmapping(AlienearImageColorMapping obj)
        {
            _alienearproductRepositorymapping.Delete(obj);
            _eventPublisher.EntityUpdated(obj);
        }
        public virtual AlienearImageColorMapping GetProductImagesByProductIdSingle(int productId)
        {
            //var imagePictures = "";
            //var query = from pp in _alienearproductRepositorymapping.Table
            //            //join xx in _alienearproductRepository.Table on pp.ColorID equals xx.ColorId
            //            where pp.ProductID == productId
            //            select pp;
            AlienearImageColorMapping query = _alienearproductRepositorymapping.Table.Where(x => x.ImageId == productId).FirstOrDefault();
            //select new
            //{
            //    ImageId = pp.ImageId,
            //    ProductID = pp.ProductID,
        ...
        public virtual List<AlienearImageColorMapping> GetProductImagesAllByColorIdId(int colorId)
        {
            //var imagePictures = "";
            //var query = from pp in _alienearproductRepositorymapping.Table
            //            //join xx in _alienearproductRepository.Table on pp.ColorID equals xx.ColorId
            //            where pp.ProductID == productId
            //            select pp;
            var query = _alienearproductRepositorymapping.Table.Where(x => x.ColorID == colorId);
            //select new
            //{
            //    ImageId = pp.ImageId,
            //    ProductID = pp.ProductID,
        ...
        public virtual string GetColorByColorId(int colorId)
        {
            //var query =  _alienearproductRepository.Table;
            //var color = query.ToList();
            return _alienearproductRepository.Table.Where(x => x.ColorId == colorId).FirstOrDefault().ColorImage;
        }
        public virtual string GetColorNameByColorId(int colorId)
        {
            //var query =  _alienearproductRepository.Table;
            //var color = query.ToList();
            return _alienearproductRepository.Table.Where(x => x.ColorId == colorId).FirstOrDefault().ColorName;
        }
        public virtual int GetColorCountByColorName(string ColorName)
        {
            //var query =  _alienearproductRepository.Table;
            //var color = query.ToList();
            return _alienearproductRepository.Table.Where(x => x.ColorName.ToUpper() == ColorName.ToUpper()).ToList().Count;
        }


        public virtual int GetColorCodeCountByColorName(string ColorCode)
        {
            //var query =  _alienearproductRepository.Table;
            //var color = query.ToList();
            return _alienearproductRepository.Table.Where(x => x.ColorImage.ToUpper() == ColorCode.ToUpper()).ToList().Count;
        }
        public virtual void InsertProductColorDetails(AlienearColorMaster ProductColor)
        {
            if (ProductColor == null)
                throw new ArgumentNullException("productColor");

            _alienearproductRepository.Insert(ProductColor);

            //event notification
            _eventPublisher.EntityInserted(ProductColor);
        }
        public virtual void EditProductColorDetails(AlienearColorMaster ProductColor)
        {
            if (ProductColor == null)
                throw new ArgumentNullException("productColor");
            AlienearColorMaster ProductColor1 = _alienearproductRepository.Table.Where(x => x.ColorId == ProductColor.ColorId).FirstOrDefault();
            ProductColor1.ColorImage = ProductColor.ColorImage;
            ProductColor1.ColorName = ProductColor.ColorName;
            _alienearproductRepository.Update(ProductColor1);

            //event notification
            _eventPublisher.EntityUpdated(ProductColor1);
        }
        public virtual void InsertProductColorImageDetails(AlienearImageColorMapping ProductColor)
        {
            if (ProductColor == null)
                throw new ArgumentNullException("productColor");

            AlienearImageColorMapping obj = new AlienearImageColorMapping();
            obj.ColorID = ProductColor.ColorID;
            obj.ImageIdividualFlag = ProductColor.ImageIdividualFlag;
            obj.ImageLeftEar = ProductColor.ImageLeftEar;
            obj.ImageRightEar = ProductColor.ImageRightEar;
            obj.ProductID = ProductColor.ProductID;
            _alienearproductRepositorymapping.Insert(ProductColor);

            //event notification
            _eventPublisher.EntityInserted(ProductColor);
        }
        public virtual string DeleteProductColorDetails(int colorId)
        {
            if (colorId == null)
                throw new ArgumentNullException("productColor");

            AlienearColorMaster obj = _alienearproductRepository.GetById(colorId);


            _alienearproductRepository.Delete(obj);

            //event notification
            _eventPublisher.EntityDeleted(obj);
            return obj.ColorName;
        }
        public virtual string[] DeleteProductColorImageDetails(int imageId)
        {
            if (imageId == null)
                throw new ArgumentNullException("productColorImage");

            AlienearImageColorMapping obj = _alienearproductRepositorymapping.GetById(imageId);
            string[] str = new string[2];
            str[0] = obj.ImageLeftEar;
            str[1] = obj.ImageRightEar;
        ...
        public virtual List<AlienearColorMaster> GetColors()
        {
            //var query =  _alienearproductRepository.Table;
            //var color = query.ToList();
            return _alienearproductRepository.Table.ToList();
        }
